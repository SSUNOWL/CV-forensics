...
The miner supports `max_samples` and does not modify training data. It can mine from manifest-provided predictions for guarded dry analysis; checkpoint-backed mining should use calibrated report outputs as records.
