#!/usr/bin/env python3
"""Validate final cross-model comparison config."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if len(argv) != 1:
        print("usage: validate_snsaug_v2_final_cross_model_comparison_config.py <config-path>")
        return 2
    ...
    if errors:
        print("SNSAUG_V2_0077_FINAL_CROSS_MODEL_COMPARISON_CONFIG_INVALID")
        for error in errors:
            print(error)
        return 1
